    ...
    <div class="col-lg-12">
        <div class="row">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <a href="#" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#delUser{{ $user->id }}"> <i class="fa fa-trash"></i> Delete</a>
                                        </div>
                                    </td>
                                </tr>
                                    ...
                                    <!-- Modal of Deleting new user -->

                                    <div class="modal right fade" id="delUser{{ $user->id }}" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('users.destroy', $user->id) }}" method="post">
                                                        @csrf
                                                        @method('DELETE')
                                                        <p> Are you shure you want to delete this {{ $user->name }}</p>
                                                        <div class="modal-footer">
            ...
            <div class="col-md-3">
                <div class="card">
                    <div class="card-header">
                        <a href=""> <i class="fa fa-plsu"></i>Search user</a>
                    </div>
                    <div class="card-body">
                        ................
                    </div>
